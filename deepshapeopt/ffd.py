...
coordinates of a :class:`~deepshapeopt.domain_frame.DomainFrame` (its knot vectors
...
:mod:`deepshapeopt.parameters` and the lattice exports in
    ...
    for face in faces:
        ...
        if n_free:
            raise ValueError(
                ...
                f"the fixed geometry at that face. Add '{face}' to optimization.lock_domain.faces."
            )
